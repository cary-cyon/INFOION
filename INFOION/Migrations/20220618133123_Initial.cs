    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryPublisher", x => new { x.CountriesId, x.PublishersId });
                    table.ForeignKey(
                        name: "FK_CountryPublisher_Countries_CountriesId",
                        column: x => x.CountriesId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CountryPublisher_Publishers_PublishersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryPublisher_PublishersId",
                table: "CountryPublisher",
                column: "PublishersId");
